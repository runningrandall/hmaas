...
| Service | Recommended Cadence | Unit of Measure | Price Per Unit |
|---|---|---|---|
| Window Cleaning | 3x per year | per window | $8.00 |
| Lawn Aeration | 2x per year (spring & fall) | per 0.25 acre | $12.00 |
| Lawn Mow & Trim | Weekly (seasonal) | per 0.25 acre | $60.00 |
| Lawn Fertilizer | 5x per year | per 0.25 acre | $50.00 |
| Sprinkler Winterization | 1x per year (fall) | per zone | $18.00 |
| Shrub Pruning | 3x per year | per shrub | $10.00 |
| Gutter Cleaning | 1x per year | per linear foot | $1.00 |
